...
namespace FFMpegResonite.Tests;

internal class Program
{
    static void Main()
    {
        var inputPath = @"C:\Users\BenjaminEvans\AppData\Local\Temp\Solirax\Resonite\Cache\FFMPEG\2023-02-21_08-06-15.mp4";
        var inputMP3 = "input.mp3";
        var inputGIF = "input.gif";

        var outputVideo = "output.mp4";
        
        var outputAudio = @"C:\Users\BenjaminEvans\AppData\Local\Temp\Solirax\Resonite\Cache\FFMPEG\2023-02-21_08-06-15.ogg";
